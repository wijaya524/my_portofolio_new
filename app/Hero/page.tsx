...
const CircuitEffect = () => {
  ...
  return (
    <div className="absolute inset-0 flex justify-center items-center" id="hero">
...
const HeroPage = () => {
  ...
  return (
    <section
      className={`relative w-full min-h-screen flex justify-center items-center overflow-hidden bg-black text-gray-200 ${
        !mounted
