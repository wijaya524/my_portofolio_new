...
const SkillsPage = () => {
  ...
  return (
    <div id="skills" className="min-h-screen flex flex-col items-center justify-center text-white p-4 sm:p-6 lg:p-10 relative overflow-hidden bg-gray-900">
      {/* Background elements */}
      ...
      <div className="w-full max-w-6xl mx-auto relative" ref={containerRef}>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 relative z-10">
          {skills.map((skill, index) => (
            ...
            >
              <div className="relative bg-gray-800/80 backdrop-blur-sm rounded-lg p-3 sm:p-4 md:p-5 flex flex-col items-center justify-center border border-gray-700 hover:translate-y-1 hover:scale-105 transition-transform duration-300 hover:shadow-[0_0_10px_rgba(56,189,248,0.5)]">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-900/10 via-blue-400/10 to-purple-600/10 rounded-lg"></div>
                ...
                <span className="text-xs sm:text-sm font-medium tracking-wider text-center">
                  {skill.name}
                </span>
                
                {/* Dots di sudut-sudut (permanent, tidak perlu hover) */}
                <div className="absolute top-1 left-1 w-1 h-1 bg-blue-400 rounded-full shadow-glow"></div>
                <div className="absolute top-1 right-1 w-1 h-1 bg-purple-400 rounded-full shadow-glow"></div>
                <div className="absolute bottom-1 left-1 w-1 h-1 bg-cyan-400 rounded-full shadow-glow"></div>
                <div className="absolute bottom-1 right-1 w-1 h-1 bg-indigo-400 rounded-full shadow-glow"></div>
              </div>
            </div>
          ))}
        </div>
